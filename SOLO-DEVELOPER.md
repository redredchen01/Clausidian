...
```bash
# Monday
cd ~/workspace/project-a && dev1  # Work on Project A

# Wednesday
cd ~/workspace/project-b && dev2  # Switch to Project B

# Thursday
cd ~/workspace/project-c && dev3  # Switch to Project C

# Friday
cd ~/workspace/project-a && dev1  # Back to Project A
